    ...
    public class AuthenticationController: ControllerBase
    {
        ...
        public async Task<ActionResult> Login([FromBody] LoginDTO login)
        {
            ...
            Response.Cookies.Append("refreshToken", refreshToken, new CookieOptions
            {
                ...
                Expires = DateTimeOffset.UtcNow.AddDays(30) // Время жизни cookie
            });
        ...
        public async Task<ActionResult> RefreshToken([FromBody] RefreshDTO model)
        {
        ...
        [Authorize] // Decorate protected API endpoints with the [Authorize] attribute to ensure only authenticated users can access them
        [HttpGet("GetRoles")]
